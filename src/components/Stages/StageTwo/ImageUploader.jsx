...
const ImageUploader = (props) => {
  const [imageUrl, setImageUrl] = useState(
    localStorage.getItem("avatar-url") || ""
  );
    ...
    <div className="image-container">
      ...
      <div className="image-backdrop">
        <div
          style={{
            background: `${
              imageUrl ? "url(" + imageUrl + ")" : "#0E464F"
            } no-repeat center/cover`,
          }}
          className={`image-uploader${
            imageUrl.length === 0 ? "" : " uploaded"
          }`}
        ...
        >
          ...
          <svg
            className={`${imageUrl.length === 0 ? "visible" : " hidden"}`}
          ...
          <p
            className={`guide${imageUrl.length === 0 ? " visible" : " hidden"}`}
          >
